...
This project is a Graphical BMI Calculator built using Python’s Tkinter
library. It calculates BMI, stores data in SQLite, shows history, and
displays BMI trends using matplotlib.
